...
var httpTestServers = function(endpoints, servers, options){
  ...
  giveMe.all(setupServer, _.map(servers, function(server, serverName){ return [serverName, server, self]; }), function(){});
  ...
  return _.extend(this, {
    kill: function(callback){
      ...
      giveMe.all(killServer, _.map(self.servers, function(server){ return [server]; }), function(){
        callback();
      });
    },
